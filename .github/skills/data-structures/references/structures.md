...
```bash
# Check raw tables
uv run python parser/utils/inspect_raw.py gtc2

# Check parsed data
uv run python parser/utils/inspect_parsed.py gtc2

# Compare raw vs parsed for a scenario
uv run python parser/utils/compare_data.py gtc2 1
...
- [raw_table_extractor.py](../../parser/pipeline/raw_table_extractor.py) - Stage 1: PDF → raw tables
- [parse_raw_tables.py](../../parser/pipeline/parse_raw_tables.py) - Stage 2: raw → parsed
- [convert_to_web.py](../../parser/pipeline/convert_to_web.py) - Stage 3: parsed → web JSON
